	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"photo":{
					"regex":/^.*?\.(gif|png|jpg|jpeg|bmp|JPG|GIF|PNG|JPEG|DMP)$/,
					"alertText":"* 图片格式不正确"
				},
			  	"checkCardNumberAjax": {
			  		"url": "./ajax/checkCardNumber.action",
			  		"extraDataDynamic":["#cardType","#memberNo"],
			  		"alertTextOk": "* 此证件号可以使用",
			  		"alertText": "* 此证件号已被其他人使用",
			  		"alertTextLoad": "* 正在确认此证件号是否有其他人使用，请稍等。"
				},
				"checkUsernameAjax": {
					"url": "ajax/checkUsername",
					"alertTextOk": "* 此用户名可以使用",
					"alertText": "* 此用户名被其他人使用",
					"alertTextLoad": "* 正在确认此用户名是否有其他人使用，请稍等。"
				},
				"passwordEqual": {
