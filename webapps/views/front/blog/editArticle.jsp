...
<body style="background-color: #d3eae7;">
	...
	<div class="panel panel-default"  style="width: 60%;margin:0 auto">
		...
		<div class="panel-body">
			<form action="upd_art" method="post" id="frm">
				<input type="hidden" name="personalBlog" value="true">
				<table class="table">
					<tr>
						<td><label class="text-primary">主题</label> <input type="text"
							name="blog.blogTitle" class="validate[required]" id="subject" value="${blog.blogTitle }"></td>
					</tr>
					<%-- <tr>
					...
					<tr>
						...
						<input type="hidden" name="blog.blogId" id="cwnh" value="${blog.blogId }">
						<br>
					...
					<tr>
						<td align="center"><input type="button" onclick="publishArt()"
							class="btn btn-primary" value="更新" /></td>
					</tr>
					<script type="text/javascript">
					<!--
						function publishArt(){
